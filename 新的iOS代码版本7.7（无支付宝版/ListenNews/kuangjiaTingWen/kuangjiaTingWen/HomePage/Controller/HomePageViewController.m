...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    if (tableView == self.columnTableView) {
        ...
        numberOfRows = [self.newsInfoArr count] + 1;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == self.columnTableView){
        ...
        if (indexPath.row == 0) {
            ...
            if ([self.newsInfoArr[indexPath.row - 1] isKindOfClass:[MyClassroomListFrameModel class]]) {
                //推荐课程
//                RecommendClassTableViewCell *cell = [RecommendClassTableViewCell cellWithTableView:tableView];
//                cell.frameModel = self.newsInfoArr[indexPath.row - 1];
//                return cell;
                ...
                MyClassroomListFrameModel *frameModel = self.newsInfoArr[indexPath.row - 1];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == self.columnTableView || tableView == self.newsTableView) {
        ...
        if (tableView == self.newsTableView && [self.newsInfoArr[indexPath.row - 1] isKindOfClass:[MyClassroomListFrameModel class]]) {
            ...
            if ([frameModel.model.is_free isEqualToString:@"1"]||[userInfoDict[results][member_type] intValue] == 2) {
                ...
                faxianzhuboVC.jiemuID = frameModel.model.ad_id;
            ...
            //跳转未购买课堂界面
                ...
                vc.act_id = frameModel.model.ad_id;
                vc.listVC = self;
                vc.hidePayBtn = NO;
