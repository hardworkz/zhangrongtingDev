...
- (void)setModel:(MyClassroomListModel *)model
{
    ...
    if (IS_IPAD) {
        ...
        _imgRightF = CGRectMake(SCREEN_WIDTH - 120.0 / 375 * IPHONE_W, 15, 105.0 / 375 * IPHONE_W, 70.0 / 375 *IPHONE_W);
    }else{
        _imgLeftF = CGRectMake(15.0 / 375 * IPHONE_W, 15, 105.0 / 375 * IPHONE_W, 105.0 / 375 *IPHONE_W);
        _imgRightF = CGRectMake(SCREEN_WIDTH - 120.0 / 375 * IPHONE_W, 15, 105.0 / 375 * IPHONE_W, 105.0 / 375 *IPHONE_W);
    }
    ...
    _titleLabRF = CGRectMake(15.0 / 375 * IPHONE_W, _imgLeftF.origin.y,  SCREEN_WIDTH - CGRectGetMaxX(_imgLeftF) - 70.0 / 375 * IPHONE_W, titleSize.height);
...
//    RTLog(@"%f",CGRectGetMaxY(_imgLeftF));
    ...
    _describeRF = CGRectMake(_titleLabRF.origin.x, CGRectGetMaxY(_imgLeftF) - (describeSize.height), SCREEN_WIDTH - CGRectGetMaxX(_imgLeftF) - 20.0 / 375 * IPHONE_W, describeSize.height);
