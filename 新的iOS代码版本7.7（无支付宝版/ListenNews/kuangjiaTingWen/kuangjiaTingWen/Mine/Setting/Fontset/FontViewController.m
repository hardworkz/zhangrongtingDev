...
- (void)viewDidLoad {
    ...
    NSString *str = [CommonCode readFromUserD:fontSize];
...
//    }
    ...
    [ClassViewController shareInstance].contentFont = dateFont;
    ...
    [CommonCode writeToUserD:cell.textLabel.text andKey:fontSize];
    [self.navigationController popViewControllerAnimated:YES];
}
