...
- (void)setFrameModel:(PlayVCTextContentCellFramesModel *)frameModel
{
    ...
    titleLab.font = CUSTOM_FONT_TYPE(frameModel.titleFontSize);
    ...
    zhengwenTextView.font = CUSTOM_FONT_TYPE(frameModel.titleFontSize);
    ...
    if (zhengwenTextView.text.length != 0){
        NSMutableAttributedString *attributedString =  [[NSMutableAttributedString alloc] initWithString:zhengwenTextView.text attributes:@{NSForegroundColorAttributeName : HEXCOLOR(0x505050),NSFontAttributeName : CUSTOM_FONT_TYPE(frameModel.titleFontSize)}];
