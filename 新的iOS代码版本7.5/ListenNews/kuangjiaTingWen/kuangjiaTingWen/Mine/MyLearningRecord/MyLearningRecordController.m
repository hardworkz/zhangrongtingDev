...
-(NSMutableArray *)x_names{
    if (!_x_names) {
        _x_names = [NSMutableArray arrayWithArray:@[@"12.30",@"12.31",@"1.1",@"1.2",@"1.3",@"1.4",@"今天"]];
    }
    return _x_names;
}
/**
...
-(NSMutableArray *)targets{
    if (!_targets) {
        _targets = [NSMutableArray arrayWithArray:@[@150,@0,@25,@50,@30,@290,@100]];
    }
    return _targets;
}
...
- (void)setupDataView
{
    UILabel *totalTime = [[UILabel alloc]initWithFrame:CGRectMake(0, IPHONEX_TOP_H, IPHONE_W * 0.5, 20)];
    ...
    UILabel *totalTimeTextLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(totalTime.frame), IPHONE_W * 0.5, 20)];
    ...
    UILabel *dateLabel = [[UILabel alloc]initWithFrame:CGRectMake(IPHONE_W * 0.5, IPHONEX_TOP_H, IPHONE_W * 0.5, 20)];
    ...
    UILabel *dateTextLabel = [[UILabel alloc]initWithFrame:CGRectMake(IPHONE_W * 0.5, CGRectGetMaxY(dateLabel.frame), IPHONE_W * 0.5, 20)];
    ...
    UILabel *unitTextLabel = [[UILabel alloc]initWithFrame:CGRectMake(30, CGRectGetMaxY(totalTimeTextLabel.frame) + 10, IPHONE_W * 0.5, 20)];
