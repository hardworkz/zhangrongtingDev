...
- (void)setModel:(MyClassroomListModel *)model
{
    ...
    _describeF = CGRectMake(_titleLabF.origin.x, CGRectGetMaxY(_imgLeftF) - (describeSize.height>52.5?52.5:describeSize.height), SCREEN_WIDTH - CGRectGetMaxX(_imgLeftF) - 20.0 / 375 * IPHONE_W, describeSize.height>52.5?52.5:describeSize.height);
