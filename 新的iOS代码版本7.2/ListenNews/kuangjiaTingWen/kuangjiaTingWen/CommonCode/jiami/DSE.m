...
const NSString *key = @"ZmH9eB4K";
const NSString *iv = @"TW!@Geyp";
...
+(NSString *) encryptUseDES:(NSString *)plainText {
    ...
    if (cryptStatus == kCCSuccess) {
        ...
        ciphertext = [Besa64 encodeBase64Data:data];
    }
    return ciphertext;
}
...
//+ (NSString *) udid
//{
//    return[DES encryptStr:[[UIDevice currentDevice] identifierForVendor].UUIDString];
//}
//
...
//    return[DES encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
//}
//
