...
- (void)setModel:(MyClassroomListModel *)model
{
    ...
    _describeF = CGRectMake(_titleLabF.origin.x, 65.0 / 667 * SCREEN_HEIGHT, SCREEN_WIDTH - CGRectGetMaxX(_imgLeftF) - 20.0 / 375 * IPHONE_W, describeSize.height>52.5?52.5:describeSize.height);
