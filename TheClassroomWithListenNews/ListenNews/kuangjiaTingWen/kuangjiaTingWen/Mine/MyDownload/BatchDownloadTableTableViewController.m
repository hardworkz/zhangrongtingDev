            ...
            [self.selectedNewsArr enumerateObjectsUsingBlock:^(id object, NSUInteger idx, BOOL *stop)
             {
                 ...
                 WHC_Download *op = [[WHC_Download alloc]initStartDownloadWithURL:[NSURL URLWithString:downObj[@"post_mp"]] savePath:manager.userDownLoadPath savefileName:[downObj[@"post_mp"] stringByReplacingOccurrencesOfString:@"/" withString:@""] withObj:downObj delegate:nil];
                 if (op) {
