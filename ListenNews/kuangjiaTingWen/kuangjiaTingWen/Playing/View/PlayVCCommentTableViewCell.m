...
//    NSIndexPath *indexPath = [self.tableView indexPathForCell:self];
    ...
    if ([[CommonCode readFromUserD:@"isLogin"]boolValue] == YES) {
        if (sender.selected == YES){
            ...
            sender.selected = NO;
            [NetWorkTool addAndCancelPraiseWithaccessToken:[DSE encryptUseDES:ExdangqianUser] uid:_frameModel.model.uid comments_id:_frameModel.model.playCommentID sccess:^(NSDictionary *responseObject) {
